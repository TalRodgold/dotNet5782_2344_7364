...
namespace IBL
{
    namespace BO
    {
        public class DroneToList
        {
            ...
            public DroneToList(int id, string model, Enums.WeightCategories weight , float battery, Enums.DroneStatuses droneStatuses, Location location, int numberOfParcels)
            {
                Id = id;
                Model = model;
                Weight = weight;
