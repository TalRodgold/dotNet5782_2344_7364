...
namespace IBL
{
    namespace BO
    {
        public class CustomerToList
        {
            ...
            public CustomerToList(int id,string name,int phone,int numberOfParcelsThatSentAndArrived, int parcelsThatSentYetNotArrived,int parcelsRecived,int parcelsOnWayToClient)
            {
                Id = id;
                Name = name;
                Phone = phone;
